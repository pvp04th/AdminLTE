<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($filename != "") {
            ...
            $sql2 = "UPDATE user SET password='$password', fullname='$fullname', phone='$phone', email='$email', image='$filename' WHERE username = '$username'";
        } else {
            // ลบ comma ตัวสุดท้ายออก
            $sql2 = "UPDATE user SET password='$password', fullname='$fullname', phone='$phone', email='$email' WHERE username = '$username'";
        }
